# Raffa V2 prototype — unpacked sources

`../Raffa V2 Prototype.html` is a Claude Design **bundled page**: the real
...
```
Raffa V2 Prototype.html  ──unpack──▶  app.jsx (logic)  +  markup.html (view)  +  styles.css
                                              │
...
- Cite the bundled file **and** the unpacked file: "`Raffa V2 Prototype.html`
  (unpacked: `raffa-v2/markup.html`, search *Nothing needs you right now.*)".
