...
# us-01-ask-engine — Contigo answers as a savings specialist, cites, routes, or abstains

## Story

As **procurement**, I want to ask Contigo in my own words about a contract,
...
provenance, or a Contigo feature — with a button to the right screen —
...
- ADR-002 — `Contigo.Chat` allow-list `[SharedKernel, AiGateway]`; pack composition in `Contigo.Api`
...
| T02 | AI golden set (`Contigo.AiEval`) on the fixture gateway | M | phase-4 |
...
intent outcomes: `inputs/design/prototypes/contigo-v2/app.jsx` → `ask()`
and `ia-v2.md` "Ask intents". Persona prompt versioned as
`backend/src/Contigo.Chat/Prompts/answer/v2.1.md` (version logged).
