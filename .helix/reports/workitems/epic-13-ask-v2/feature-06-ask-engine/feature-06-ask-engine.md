...
`navigate`); a context pack assembled in `Contigo.Api` from the three
...
set (`Contigo.AiEval`, ≥ 40 questions, 0 numeric-guard interventions) that
...
| ID | Title | Wave |
|----|-------|------|
| us-01 | Contigo answers as a savings specialist, cites, routes, or abstains | 13 |
...
- ADR-002 — `Contigo.Chat` stays `[SharedKernel, AiGateway]`; composition in `Contigo.Api`
