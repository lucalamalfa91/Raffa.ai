...
| Path | Change |
|------|--------|
| workspace/raffa-backend/src/ | implementation for `rag-citations` |
...
|-------|----------------|-------|
| unit | rag-citations behaviour | workspace/raffa-backend/tests |
...
```yaml
- id: E02/F04/US02/T01
  prompt: reports/workitems/epic-02-contract-intelligence/feature-04-ask-raffa-citations/us-02-rag-citations/tasks/task-01-rag-citations.md
