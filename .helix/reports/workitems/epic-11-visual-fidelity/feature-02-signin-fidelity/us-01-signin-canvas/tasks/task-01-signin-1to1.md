...
- Lockup: 14×14 accent square + "Raffa" 22px/800
...
- `h2` "Sign in" (not "Raffa")
- muted sentence: "Use your organisation account. Raffa never stores your password — identity is handled by Microsoft Entra ID."
