...
/// (`contigo-v2/screens-v2.md`: "turns You ... Contigo ...") name. Stored as a string via
...
/// already uses, e.g. <c>Contigo.Documents.Contracts.Domain.Contract.Type</c>) — task
/// E13/F05/US01/T02 (the API layer) owns mapping these PascalCase members onto the wire-format
/// lowercase `you`/`contigo` literals ADR-024's reply contract names.
/// </summary>
public enum ConversationRole
{
    ...
    /// <summary>Contigo's own reply — produced by the Ask engine (a later task; this task only
