...
namespace Contigo.Chat.Migrations
{
    ...
    /// <see cref="Contigo.SharedKernel.Tenancy.TenantRlsConnectionInterceptor"/> sets — the exact
    /// same SQL shape as
    /// <c>Contigo.Documents.Contracts.Migrations.AddTenantRowLevelSecurity</c> (see that
    ...
    {
        /// <summary>
        /// Every table backed by a <see cref="Contigo.Chat.Domain.Conversations.TenantScopedEntity"/>
