...
/// "Persona prompt versioned as `backend/src/Contigo.Chat/Prompts/answer/v2.1.md` (version
...
/// constant is what <see cref="AnswerComposer"/> can hand to <c>Contigo.AiGateway.Contracts
...
/// <c>Contigo.AiGateway.Foundry.Prompts.AnswerPersonaPrompt</c>/<c>ClassifyPromptTemplate</c>
...
{
    /// <summary>Logged as <c>Contigo.AiGateway.Contracts.AiCallMetadata.PromptVersion</c> is
    ...
    public const string SystemPrompt =
        """
        You are Ask Contigo, a savings and negotiation specialist for procurement teams - never a
