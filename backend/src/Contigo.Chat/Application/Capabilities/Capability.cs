...
/// <c>Contigo.Identity.Workspace.Domain.WorkspaceRoleName</c> catalog: <c>Contigo.Chat</c>'s own
/// architecture allow-list (<c>Contigo.ArchitectureTests.DependencyDirectionTests</c>) is exactly
/// <c>[SharedKernel, AiGateway]</c>, so this module cannot reference
/// <c>Contigo.Identity.Workspace</c> at all — <c>Contigo.Api</c> (the one project allowed to
...
public enum CapabilityAvailability
{
    ...
    /// <summary>Greyed until the first validated contract exists (`contigo-v2/ia-v2.md`
