...
/// The one shape every gate label / guard outcome ultimately produces — <c>Contigo.Api</c>'s
...
/// <c>Contigo.Chat.Application.Conversations.AppendConversationMessageRequest</c> row.
/// </summary>
