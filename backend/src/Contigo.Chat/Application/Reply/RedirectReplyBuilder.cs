...
/// No <c>Contigo.AiGateway</c> call happens for any of these — <see cref="ReplyProvenance.NoModelCall"/>
...
public static class RedirectReplyBuilder
{
    ...
    public static CopilotReply GreetingOrOffDomain(string? hookSentence, IReadOnlyList<CopilotAction> actions)
    {
        ...
        var markdown = hookSentence is not null
            ? $"Hi! I'm Contigo, your savings copilot — I only answer from your validated " +
              $"contracts, never the web. For example, {hookSentence}. Ask me about dates, spend, " +
              "notice periods or clauses whenever you're ready."
            : "Hi! I'm Contigo, your savings copilot. Nothing is validated yet, so I have nothing to " +
    ...
    /// <param name="citations">Feature citation cards (<see cref="Pack.PackCorpus.Contigo"/>) for
