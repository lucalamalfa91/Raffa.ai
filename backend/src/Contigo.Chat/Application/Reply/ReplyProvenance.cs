...
/// of <c>tenant</c>/<c>market</c>/<c>contigo</c>/<c>calc</c> (<see cref="Pack.PackCorpus"/>), empty
/// for a reply with no citations at all.</param>
/// <param name="ModelId">Echoes <c>Contigo.AiGateway.Contracts.AiCallMetadata.ModelId</c> when an
