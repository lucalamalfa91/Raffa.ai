...
namespace Contigo.Chat.Application.Planning;
...
/// (`inputs/design/prototypes/contigo-v2/app.jsx` → <c>ask(text, scope)</c>, echoed in
/// `contigo-v2/ia-v2.md` "Ask intents in the prototype") is the behavioural oracle this planner
...
/// all, the same determinism convention <c>AskContigoQueryRouter</c>/
/// <c>DeterministicQueryPlanner</c> already establish for the older, single-turn query router this
/// engine supersedes for Ask Contigo's own gate/planner responsibilities).
/// </para>
///
/// <para>
/// Reuses <c>AskContigoQueryRouter</c>'s legal/clause vocabulary for <see cref="AskIntent.Clause"/>
