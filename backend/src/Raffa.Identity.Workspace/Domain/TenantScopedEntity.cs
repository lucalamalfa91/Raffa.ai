...
/// <c>Raffa.Documents.Contracts.Domain.TenantScopedEntity</c> already uses: ADR-002's
/// dependency-direction rule (enforced by <c>Raffa.ArchitectureTests.DependencyDirectionTests</c>)
/// only allows this module to reference <c>Raffa.SharedKernel</c>, never another domain
