...
namespace Contigo.Insights.Strategy;
...
{
    /// <summary>The four tracker steps, verbatim from <c>contigo-v2/app.jsx</c>'s own
    ...
    /// <c>Contigo.Insights.Tests.StrategyPackBuilderTests</c>.
    /// </summary>
    ...
    /// the same preference <c>Contigo.Renewals.Application.RenewalPipelineBuilder
