...
/// <c>Contigo.Insights.Negotiation.PricedLineNegotiationCalculator</c>,
/// <c>Contigo.Insights.Strategy.StrategyPackBuilder</c> and their tests all build the same three
...
public static class InsightsCitationKeys
{
    ...
    /// <summary>A market-intelligence record (<c>Contigo.Market</c>'s own <c>MarketDeal</c>/
    ...
    /// <c>Contigo.Quotes.Application.Strategy.NegotiationLeverEvidence</c>'s own "name the
