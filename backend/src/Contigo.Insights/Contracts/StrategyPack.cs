...
/// <summary>
/// The outcome of <c>Contigo.Insights.Strategy.StrategyPackBuilder.Build</c> (task
...
/// <param name="NextSteps">The four tracker steps, in order (<c>contigo-v2/app.jsx</c>
/// <c>stepDefs</c>).</param>
...
/// <c>Contigo.Insights.Criticality.CriticalityScoreCalculator</c>'s own open-critical-facts
...
/// verbatim — this builder never re-derives a date <c>Contigo.Renewals.Application.RenewalEngine</c>
...
/// <c>Contigo.Renewals.Application.RenewalPipelineBuilder.DetermineRecommendation</c>'s own
...
/// <c>Contigo.Insights.Contracts.PricedLineNegotiationResult</c>'s own numeric fields for this line —
/// <see cref="Description"/> identifies which line, since <see cref="StrategyPack.Targets"/> is a
/// flat list, not keyed by an id (a <c>Contigo.Benchmark.Contracts.PricedLine</c> carries no id of
...
/// (<c>contigo-v2/app.jsx</c> <c>stepDefs</c>, verbatim order: Notify → Request revised pricing and
