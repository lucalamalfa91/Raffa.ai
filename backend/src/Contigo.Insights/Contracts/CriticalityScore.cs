...
/// <summary>
/// The outcome of <c>Contigo.Insights.Criticality.CriticalityScoreCalculator.Calculate</c> (task
...
/// Mirrors <c>Contigo.Renewals.Application.PriorityScoreResult</c>'s own "never a bare number" shape
...
/// (<c>Contigo.Insights.InsightsOptions</c>) sum to 1.0, as validated at construction.</param>
...
/// <c>Contigo.Renewals.Application.PriorityScoreComponent</c>'s own shape, plus <see cref="Weight"/>
