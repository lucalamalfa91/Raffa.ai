...
namespace Contigo.Insights.Criticality;
...
/// <c>Contigo.Renewals.Application.PriorityScoreCalculator</c> already established for the
...
public sealed class CriticalityScoreCalculator
{
    ...
    /// against this spec-default maximum (<c>Contigo.Renewals.Application.PriorityScoreCalculator
    ...
    /// Every branch is covered by <c>Contigo.Insights.Tests.CriticalityScoreCalculatorTests</c>.</summary>
    ...
    /// <c>Contigo.Renewals.Application.RenewalPipelineBuilder.Build</c>'s own tie-break convention) —
    ...
    /// <c>Contigo.Renewals.Application.PriorityScoreCalculator.Fmt</c>).</summary>
