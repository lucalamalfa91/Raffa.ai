...
/// not re-implement" posture <c>Contigo.Quotes.Application.Strategy.NegotiationStrategyService</c>
    ...
    IAuditWriter auditWriter)
{
    ...
    /// <see cref="Quote"/> for the caller's tenant. <c>Contigo.Api.QuotesEndpointExtensions</c> maps
    ...
    /// <c>Contigo.Documents.Contracts.Application.ContractCorrectionService.CorrectAsync</c> already
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (validatedCorrections.Count > 0)
        {
            ...
            // Contigo.Api.QuoteExtractionPipeline's own doc comment documents for QuoteLines.
...
/// <c>Contigo.Api.QuotesEndpointExtensions</c> folds this into `POST
...
/// <param name="NormalizationOutcome">The same per-quote counts <c>Contigo.Api.QuoteExtractionPipeline</c>'s
