...
namespace Contigo.Suppliers.Products.Domain;
...
/// <c>Contigo.Renewals.Domain.TenantScopedEntity</c>, and every other module's own copy already
/// use: ADR-002's dependency-direction rule (enforced by
/// <c>Contigo.ArchitectureTests.DependencyDirectionTests</c>) only allows this module to reference
/// <c>Contigo.SharedKernel</c>, never another domain module's internals, so the base type is
