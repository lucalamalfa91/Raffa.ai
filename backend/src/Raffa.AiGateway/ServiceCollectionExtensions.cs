...
/// <see cref="Raffa.Documents.Contracts.Infrastructure.ServiceCollectionExtensions
/// .AddDocumentsContractsModule"/> (that module is the first, and today only, consumer — its own
/// allow-listed reference to <c>Raffa.AiGateway</c> is exactly for this), so every host that
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddAiGatewayModule(this IServiceCollection services)
    {
        ...
        // registration wins (mirrors Raffa.Documents.Contracts.Infrastructure.ServiceCollectionExtensions).
        ...
        // parameter threaded through every caller (Raffa.Api/Program.cs,
        // Raffa.Worker/WorkerServiceCollectionExtensions, AddDocumentsContractsModule).
        ...
        // IAuditWriter, which Raffa.Audit.Infrastructure.ServiceCollectionExtensions
