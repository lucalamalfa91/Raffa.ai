...
/// this assembly (see <c>Contigo.Market.csproj</c>'s <c>EmbeddedResource</c> item) rather than
...
{
    private const string EmbeddedResourceName = "Contigo.Market.Fixtures.market-intelligence.mock.json";
    ...
    private static FixtureDocument LoadFixture()
    {
        ...
        using var stream = assembly.GetManifestResourceStream(EmbeddedResourceName)
            ?? throw new InvalidOperationException(
                ...
                $"{assembly.GetName().Name}. Check the EmbeddedResource item in Contigo.Market.csproj.");
