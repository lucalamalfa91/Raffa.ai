...
namespace Contigo.Market.Infrastructure.Configurations;
...
public sealed class MarketEmbeddingConfiguration : IEntityTypeConfiguration<MarketEmbeddingEntity>
{
    public void Configure(EntityTypeBuilder<MarketEmbeddingEntity> builder)
    {
        ...
        // same module/DbContext, unlike Contigo.Documents.Contracts.Domain.Embedding's own
        ...
        // Contigo.Chat.Infrastructure.Configurations.ConversationMessageConfiguration already uses
