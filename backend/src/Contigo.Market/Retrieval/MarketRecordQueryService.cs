...
/// <summary>
/// Backs <c>Contigo.Api.MarketEndpointExtensions</c>'s <c>GET /api/market/records/{id}</c> (task
...
/// <c>Contigo.Documents.Contracts.Application.DocumentQueryService</c>'s identical split.
/// </summary>
