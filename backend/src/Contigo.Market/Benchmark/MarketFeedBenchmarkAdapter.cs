...
/// <see cref="Contigo.Benchmark.IBenchmarkService"/> adapter (spec §10.2's Benchmark Service
...
/// change to <see cref="Contigo.Benchmark.IBenchmarkService"/> or any domain-module call site.
///
