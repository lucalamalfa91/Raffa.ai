...
namespace Raffa.Audit.Migrations
{
    /// <summary>
    ...
    /// is the CI migration check (`Raffa.Audit.Tests.AuditRlsMigrationCheckTests`), which
    /// discovers tenant-scoped tables dynamically from the EF model (every
    /// <see cref="Raffa.Audit.Domain.TenantScopedEntity"/> subclass) rather than from this
    /// hardcoded list.
    /// </summary>
    public partial class AddTenantRowLevelSecurity : Migration
    {
        /// <summary>
        /// Every table backed by a <see cref="Raffa.Audit.Domain.TenantScopedEntity"/>
