...
namespace Contigo.Renewals.Migrations
{
    ...
    /// <c>renewal_alert</c> (see <see cref="Contigo.Renewals.Domain.RenewalAlert"/>'s own doc
    ...
    /// <c>Contigo.Quotes.Migrations.AddSkuProductMapping</c>/<c>AddNegotiationOutcome</c> already set
    /// for this exact scenario one module over).
    /// <c>Contigo.Renewals.Tests.RenewalActionRlsMigrationCheckTests</c> (a generic, EF-model-driven
