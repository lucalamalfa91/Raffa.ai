using Raffa.Market.Infrastructure.Configurations;
...
/// <c>Raffa.Documents.Contracts.Infrastructure.DocumentsContractsDbContext</c>'s own
/// <c>Raffa.SharedKernel.Tenancy.ITenantContext</c>/<c>TenantRlsConnectionInterceptor</c> wiring —
