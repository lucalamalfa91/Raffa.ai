...
/// <summary>
/// Raffa's own normalized market-intelligence record (`inputs/requirements.md` R-MKT-01;
/// council decision carried into us-01-market-intelligence: "the mock record shape is Raffa's
...
/// — they only ever see it through <see cref="Raffa.Benchmark.Contracts.BenchmarkResult"/>
