...
/// savings-opportunity — the first task to give <c>Raffa.Savings</c> a <c>DbContext</c>). ADR-009
...
/// <c>Raffa.Identity.Workspace.Domain.TenantScopedEntity</c> and
/// <c>Raffa.Renewals.Domain.TenantScopedEntity</c> already use: ADR-002's dependency-direction
