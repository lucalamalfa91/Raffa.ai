...
namespace Raffa.Insights.Negotiation;
...
/// <c>Raffa.Quotes.Application.Strategy.NegotiationStrategyCalculator</c> computes for a quote
...
/// <c>Raffa.Insights.Tests.PricedLineNegotiationCalculatorTests</c> by feeding both calculators
...
/// mirrors <c>Raffa.Quotes.Application.Assessment.TargetSavingCalculator.Compute</c>'s own P25/P50
/// clamped-to-unit-price formula (duplicated, not referenced: <c>Raffa.Insights</c> cannot
/// reference <c>Raffa.Quotes</c> — ADR-002) because <see cref="PricedLine"/> carries a raw
...
/// <c>Raffa.Quotes.Application.Strategy.NegotiationStrategyCalculator.BuildLevers</c>'s own doc
