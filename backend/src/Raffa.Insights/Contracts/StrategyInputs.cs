...
/// <summary>
/// One contract's raw facts for <c>Raffa.Insights.Strategy.StrategyPackBuilder.Build</c> (task
...
/// <c>Raffa.Renewals.Domain.RenewalCalculationStatus.NoRenewal</c>'s own distinction).</param>
/// <param name="PricedLines">Every priced line on this contract — one
/// <c>Raffa.Insights.Contracts.PricedLineNegotiationResult</c> is computed per entry; empty when
