...
namespace Raffa.Documents.Contracts.Migrations
{
    ...
    [Migration("20260924153558_AddContractLineItemMarketPriceEstimate")]
    partial class AddContractLineItemMarketPriceEstimate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.Clause", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.Contract", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.ContractLineItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.ContractLineItemMarketPrice", b =>
                {
                    ...
                    b.Property<string>("EstimateKind")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("estimate_kind");

                    b.Property<string>("EstimateProduct")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
                        .HasColumnName("estimate_product");

                    b.Property<decimal?>("EstimateUnitPriceP25")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)")
                        .HasColumnName("estimate_unit_price_p25");

                    b.Property<decimal?>("EstimateUnitPriceP50")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)")
                        .HasColumnName("estimate_unit_price_p50");

                    b.Property<decimal?>("EstimateUnitPriceP75")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)")
                        .HasColumnName("estimate_unit_price_p75");

                    b.Property<DateTimeOffset?>("EstimatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("estimated_at");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.CorrectionHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<double?>("RejectionConfidence")
                        .HasColumnType("double precision")
                        .HasColumnName("rejection_confidence");

                    b.Property<string>("RejectionDetectedType")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("rejection_detected_type");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.DocumentVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.Embedding", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.ExtractionEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.ExtractionJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.Obligation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.Risk", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.Clause", b =>
                {
                    b.HasOne("Raffa.Documents.Contracts.Domain.Contract", null)
                        .WithMany()
                    ...
                    b.HasOne("Raffa.Documents.Contracts.Domain.Document", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.ExtractionEvidence", b =>
                {
                    ...
                    b.HasOne("Raffa.Documents.Contracts.Domain.ExtractionJob", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Raffa.Documents.Contracts.Domain.Risk", b =>
                {
                    b.HasOne("Raffa.Documents.Contracts.Domain.Clause", null)
                        .WithMany()
