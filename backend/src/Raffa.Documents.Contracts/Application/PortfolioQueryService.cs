...
/// <c>Raffa.Api.Program</c>) opens a tenant scope before a read runs, so this opens its own
    ...
    DocumentsContractsDbContext dbContext, ITenantContext tenantContext, PortfolioAnalysisCalculator analysisCalculator)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Raffa.Audit.Infrastructure.AuditQueryService; Id is a tiebreaker only (for CreatedAt
