...
/// <summary>The five container formats Raffa reads (<c>inputs/requirements.md</c> R-DOC-02). Named
...
public static class DocumentFormatSniffer
{
    ...
    public const string RejectionMessage = "Raffa reads PDF, Word, Excel and scanned images";
