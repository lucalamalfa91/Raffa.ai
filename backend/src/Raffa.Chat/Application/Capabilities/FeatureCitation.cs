...
/// <summary>
/// The R-SYS-03 "feature card" citation shape: "When Ask explains a Raffa capability, the
/// citation card is a **feature card** (`corpus: raffa`): title = capability, snippet = what it
/// does, `href` = route." (story us-01-capability-catalog AC-4). Sits alongside the tenant/market
/// citation shapes a later task adds (`Raffa.AiGateway.Contracts.AiCitation` for tenant
/// evidence) — this one always resolves from the static catalog, never a retrieval call.
/// </summary>
/// <param name="Corpus">Always <see cref="RaffaCorpus"/> for a feature citation — carried as a
...
{
    public const string RaffaCorpus = "raffa";
