...
/// `backend/src/Raffa.Chat/Application/Capabilities/` (`CapabilityCatalog`, `CapabilityRouting`),
/// version string `capabilities-v2.0`"). Ten entries, one per V2 route in
/// `inputs/design/prototypes/raffa-v2/ia-v2.md`'s route map plus the two Documents sub-states
/// R-SYS-01/R-SYS-03 name (`documents-attention`, `documents-review`) — `/signin` is excluded, it
/// is authentication, not a Raffa capability a user asks Ask about.
///
/// <para>
...
///
/// <para>
/// Sources: `raffa-v2/app.jsx`'s `ask()` capabilities branch ("I answer from your validated
/// contracts and route you to the right part of Raffa: • Documents — upload contracts, review
...
/// your history."), `chipsFor`/`c360Chips`, `raffa-v2/markup.html` (the "Documents › Review"
...
/// <see cref="CapabilityRouting.ValidatedContractsEmptyStateCopy"/>), `raffa-v2/screens-v2.md`.
/// </para>
/// </summary>
public static class CapabilityCatalog
{
    ...
    [
        new Capability(
            ...
            ["What can Raffa do?", "When does this contract expire?", "What liabilities do we have?"],
            ...
            [
                ...
                "Raffa authorises the scope, detects the intent and retrieves the evidence before it answers.",
        ...
        new Capability(
            ...
            "review the fields Raffa is not yet confident about before they count as validated.",
            ...
            [
                ...
                "Raffa parses, classifies and extracts the contract automatically; anything that " +
        ...
        new Capability(
            ...
            [
                ...
                "Upload the supplier's quote — Raffa extracts and normalizes each line.",
