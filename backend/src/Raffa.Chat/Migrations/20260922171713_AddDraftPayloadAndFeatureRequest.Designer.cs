...
namespace Raffa.Chat.Migrations
{
    ...
    [Migration("20260922171713_AddDraftPayloadAndFeatureRequest")]
    partial class AddDraftPayloadAndFeatureRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Raffa.Chat.Domain.Conversations.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Chat.Domain.Feedback.FeatureRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("WorkspaceHash")
                        ...
                        .HasColumnName("workspace_hash");

                    b.HasKey("Id")
                        .HasName("pk_feature_request");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_feature_request_tenant_id");
