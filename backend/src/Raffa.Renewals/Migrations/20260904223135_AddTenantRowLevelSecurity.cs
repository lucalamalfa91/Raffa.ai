...
namespace Raffa.Renewals.Migrations
{
    ...
    /// CI migration check (`Raffa.Renewals.Tests.RenewalActionRlsMigrationCheckTests`), which
    /// discovers tenant-scoped tables dynamically from the EF model (every
    /// <see cref="Raffa.Renewals.Domain.TenantScopedEntity"/> subclass) rather than from this
    /// hardcoded list.
    /// </summary>
    public partial class AddTenantRowLevelSecurity : Migration
    {
        /// <summary>
        /// Every table backed by a <see cref="Raffa.Renewals.Domain.TenantScopedEntity"/>
