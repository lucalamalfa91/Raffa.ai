...
namespace Raffa.Renewals.Migrations
{
    ...
    [Migration("20260917131939_AddRenewalNegotiationTodo")]
    partial class AddRenewalNegotiationTodo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Raffa.Renewals.Domain.RenewalAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Renewals.Domain.RenewalAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Raffa.Renewals.Domain.RenewalNegotiationTodo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<string>("CitationKeys")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("citation_keys");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_renewal_negotiation_todo");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_renewal_negotiation_todo_tenant_id");

                    b.HasIndex("TenantId", "ContractId", "PointKey")
                        .IsUnique()
                        .HasDatabaseName("ix_renewal_negotiation_todo_tenant_contract_point_key");

                    b.ToTable("renewal_negotiation_todo", (string)null);
                });
