...
public sealed class NumericGuardTests
{
    ...
    private static readonly Contigo.AiGateway.Contracts.AiCallMetadata Metadata =
    ...
    public void A_date_quoted_verbatim_from_a_pack_snippet_grounds_even_without_a_structured_value()
    {
        ...
        // (Contigo.IntegrationTests.R1EndToEndTests's own fixture text, R1ExtractionFixtures.cs).
        var pack = new[]
        {
            MarketDeal(
                "tenant:contract-1",
