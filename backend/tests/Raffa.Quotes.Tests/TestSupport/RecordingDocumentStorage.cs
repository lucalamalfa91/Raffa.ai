...
/// <summary>
/// Fake <see cref="IDocumentStorage"/> for <see cref="Raffa.Quotes.Application.QuoteUploadService"/>
/// tests — proves the storage step without a real Azure Blob/Azurite dependency, mirroring
/// <c>Raffa.Documents.Contracts.Tests.DocumentUploadServiceTests</c>'s own test double of the same
