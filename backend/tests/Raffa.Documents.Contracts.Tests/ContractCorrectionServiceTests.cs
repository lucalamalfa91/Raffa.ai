...
{
    private const string AppRoleName = "raffa_correction_app";
    private const string AppRolePassword = "raffa_correction_app_test_password";
    ...
    /// name as <c>Raffa.Documents.Contracts.Tests.DocumentUploadServiceTests.RecordingAuditWriter</c>
    ...
    /// up a real Postgres-backed <c>Raffa.Audit.Infrastructure.AuditWriter</c>.</summary>
