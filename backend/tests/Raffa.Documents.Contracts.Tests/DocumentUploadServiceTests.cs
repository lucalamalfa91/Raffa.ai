...
/// <c>Raffa.Tenancy.Tests.TenantRlsCrossTenantIsolationTests</c> and
...
{
    private const string AppRoleName = "raffa_upload_app";
    private const string AppRolePassword = "raffa_upload_app_test_password";
