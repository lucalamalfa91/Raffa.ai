...
public sealed class StagedExtractionServiceTests : IAsyncLifetime
{
    ...
    /// <see cref="Raffa.AiGateway.Fixtures.FixtureAiGateway"/> already proves the real,
    ...
    /// suffix and all; normalizing it for matching is <c>Raffa.Suppliers.Products</c>'s job, not
