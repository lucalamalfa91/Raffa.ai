...
/// <c>Raffa.Suppliers.Products.Application.SupplierNameNormalizer</c>: "Salesforce, Inc." and
...
/// ADR-002 keeps <c>Raffa.Documents.Contracts</c> — and therefore its test project — from
/// referencing <c>Raffa.Suppliers.Products</c> at all. The real normalizer's exact suffix list and
/// punctuation rules are proven by <c>Raffa.Suppliers.Products.Tests</c>; this only needs to be
