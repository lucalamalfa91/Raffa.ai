...
///
/// <para>
/// Task E13/F06/US01/T02 owns <c>backend/tests/Raffa.AiEval/**</c> and must not change the
...
internal static class GoldenSetKnownGaps
{
    ...
    /// <summary>
    /// <c>Raffa.Api.AskCopilotService.BuildRoutingOnlyReply</c> hard-codes the Documents
    ...
    /// <summary>
    /// <c>Raffa.Api.AskCopilotService.BuildContractFactItem</c> emits the annual-spend
    ...
    /// <summary>
    /// <c>Raffa.Api.InsightsEndpointExtensions.ComputeRenewal</c> builds its
