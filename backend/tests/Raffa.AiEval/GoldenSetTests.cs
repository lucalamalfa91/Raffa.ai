...
///
/// <para>
/// <b>Manual Foundry run</b>: <c>AiEval__UseFoundry=true dotnet test backend/tests/Raffa.AiEval</c>
...
public sealed class GoldenSetTests(GoldenSetRunner runner)
{
    ...
    /// <summary>
    /// The task's own deliverable: "emit a markdown report (`backend/tests/Raffa.AiEval/reports/
