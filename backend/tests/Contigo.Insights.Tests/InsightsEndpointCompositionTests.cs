...
/// <summary>
/// Proves task E13/F07/US01/T01's <c>Contigo.Api.InsightsEndpointExtensions</c> composition/mapping
...
/// <c>Contigo.Insights.Tests</c>, not <c>Contigo.Api.Tests</c> — see
/// <c>Contigo.Insights.Tests.csproj</c>'s own comment on why that reference is not an architecture
