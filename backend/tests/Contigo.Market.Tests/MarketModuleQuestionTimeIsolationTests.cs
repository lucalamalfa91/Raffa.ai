...
public sealed class MarketModuleQuestionTimeIsolationTests : IAsyncLifetime
{
    ...
    /// <c>Contigo.AiGateway.Logging.LoggingAiGateway</c> (which every real <see cref="Contigo.AiGateway.IAiGateway"/>
    /// consumer in this composition resolves behind) can construct without pulling in the whole
    /// <c>Contigo.Audit</c> module and its own database for this test.</summary>
