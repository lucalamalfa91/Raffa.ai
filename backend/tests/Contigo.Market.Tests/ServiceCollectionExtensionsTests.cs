...
/// that becomes the <em>default</em> active <c>Contigo.Benchmark</c> adapter — without editing
/// <c>Contigo.Benchmark</c> — regardless of whether the host calls <c>AddBenchmarkModule()</c> or
