...
/// <c>Contigo.Documents.Contracts.Application.DocumentQueryService</c>'s identical split"; this
/// class is that test, following
/// <c>Contigo.Documents.Contracts.Tests.DocumentQueryServiceTests</c>'s own field-by-field assertion
...
public sealed class MarketRecordQueryServiceTests : IAsyncLifetime
{
    ...
    public async Task Unknown_record_id_returns_null()
    {
        ...
        // The endpoint's own 404 signal (Contigo.Api.MarketEndpointExtensions.GetRecordAsync).
