...
/// citations — a subset of <c>tenant</c>/<c>market</c>/<c>contigo</c>/<c>calc</c>. Empty means
...
/// own wording for a redirect/refusal/abstain (`contigo-v2/app.jsx`'s <c>ask()</c> outcomes).</param>
...
/// produces. This task owns <c>backend/tests/Contigo.AiEval/**</c> only and is explicitly
