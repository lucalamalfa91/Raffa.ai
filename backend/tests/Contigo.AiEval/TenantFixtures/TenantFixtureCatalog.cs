...
internal static class TenantFixtureKeys
{
    ...
    /// <summary>The seeded workspace, mirroring <c>inputs/design/prototypes/contigo-v2/app.jsx</c>
...
/// (<c>contigo-v2/app.jsx</c> <c>CONTRACTS</c>), so a golden expectation can be traced straight
