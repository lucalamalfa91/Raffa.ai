...
/// <summary>
/// Captures the single per-turn audit row <c>Contigo.Api.AskCopilotService.WriteAuditAsync</c>
...
/// <c>Contigo.Api.Tests.TestSupport.InMemoryModelCustomizer</c> does): the golden set really does
...
/// <c>Contigo.IntegrationTests</c>' job against a real Postgres.
/// </para>
/// </summary>
