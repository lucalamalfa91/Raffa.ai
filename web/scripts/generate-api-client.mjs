#!/usr/bin/env node
// Generates web/src/api/generated/schema.ts from web/openapi/raffa-api.v1.json.
//
...
// "Codegen tool choice" paragraph in web/openapi/raffa-api.v1.json's
...
// drift from the contract (raffa-api.v1.json).
...
const specPath = resolve(webRoot, "openapi", "raffa-api.v1.json");
...
function renderSchemaType(schema) {
  ...
  // document to a contract; see web/openapi/raffa-api.v1.json's info.description). Each member
  ...
  switch (schema.type) {
    ...
    default:
      // Not needed by any operation web/openapi/raffa-api.v1.json documents
...
function generate(spec) {
  ...
  return (
    [
      ...
      "// Source contract: web/openapi/raffa-api.v1.json (ADR-012, api-consumption.md",
