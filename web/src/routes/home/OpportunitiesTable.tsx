...
import type { OpportunityRowView } from "./homeViewModel";
 ...
 * `<Link>` carrying `row.navigation` (`homeViewModel.ts#getOpportunityNavigation`), the same
...
export default function OpportunitiesTable({ rows }: OpportunitiesTableProps) {
  return (
    <div className="portfolio-table-wrapper">
      <table className="table home-opportunities-table">
        <thead>
          <tr>
            <th scope="col">Opportunity</th>
            <th scope="col">Type</th>
            <th scope="col" className="home-table-numeric">
              Current spend
            </th>
            <th scope="col" className="home-table-numeric">
              Estimated savings
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row.key}>
              ...
              <td>{row.type}</td>
              <td className="home-table-numeric">{row.currentSpend}</td>
              <td className="home-table-numeric">{row.estimatedSavings}</td>
              <td>
                {row.confidence !== null ? (
              ...
              <td className="home-table-numeric">{row.realized}</td>
            </tr>
          ))}
        </tbody>
      </table>
